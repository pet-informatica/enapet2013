    ...
    var clock = {
        set: {
            days: function(){
                ...
                ctx.arc(74,74,62, deg(0), deg((360/glob.total)*(glob.total - glob.days)));
                ctx.lineWidth = 10;
                ctx.stroke();
            ...
            hours: function(){
                ...
                ctx.arc(74,74,62, deg(0), deg(15*glob.hours));
                ctx.lineWidth = 12;
                ctx.stroke();
            ...
            minutes : function(){
                ...
                ctx.arc(74,74,62, deg(0), deg(6*glob.minutes));
                ctx.lineWidth = 11;
                ctx.stroke();
            ...
            seconds: function(){
                ...
                ctx.arc(74,74,62, deg(0), deg(6*glob.seconds));
                ctx.lineWidth = 11;
                ctx.stroke();
