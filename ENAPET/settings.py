# Django settings for ENAPET project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'enapet.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '4l@s9%vw0=!b$nm*ku7wx2&=x6g2l9s-3!-^@y#fhkl5$wd7sj'
...
ROOT_URLCONF = 'ENAPET.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ENAPET.wsgi.application'
